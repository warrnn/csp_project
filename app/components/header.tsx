            ...
            <div className="w-full h-full bg-slate-900/75 backdrop-blur-sm">
                <div className="w-full h-full flex justify-between px-4">
                    ...
                    <div className="h-full flex items-center text-sm">
                        <Link href="/signin" className="border border-indigo-400 py-2 px-4 rounded-md transition-all hover:bg-pink-400 hover:border-pink-400">Sign In</Link>
                        <Link href="/signup" className="border border-indigo-400 bg-indigo-400 py-2 px-4 rounded-md ml-2 transition-all hover:bg-indigo-600 hover:border-indigo-600">Get Started</Link>
                    </div>
                </div>
            </div>
        </nav>
