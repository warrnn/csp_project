...
export default function ConcertCard({ id, title, poster_url, artist, venue, concert_date, currentCapacity, maxCapacity, price, profile }: ConcertCardProps) {
    return (
        <SpotlightCard className="w-full flex flex-col border-2 bg-(--background) border-indigo-500/50 rounded-xl max-w-md overflow-hidden hover:-translate-y-2 hover:shadow-lg hover:shadow-indigo-700/80 transition-all duration-500 group">
            ...
            <div className="p-6 flex flex-col space-y-4">
                ...
                <div className="flex flex-col space-y-2 text-sm">
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <p className="text-gray-400">{currentCapacity} seats left</p>
                    </div>
                </div>
                <div>
                ...
                <div className="flex flex-col lg:flex-row space-y-4 lg:space-y-0 justify-between items-center mt-2">
                    ...
                    <Link href={`/concerts/${id}`} className="w-full lg:w-auto flex justify-center items-center space-x-2 bg-indigo-500 hover:bg-indigo-600 group-hover:drop-shadow-lg group-hover:drop-shadow-indigo-700 transition-all py-2 px-3 text-sm rounded-lg cursor-pointer">
