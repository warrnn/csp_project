            ...
            <div className="p-6 flex flex-col space-y-4">
                ...
                <div className="flex flex-col space-y-2 text-sm">
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <p className="text-gray-400">{(maxCapacity - currentCapacity)} / {maxCapacity}</p>
                    </div>
                </div>
                <div>
                    <LinearProgress variant="determinate" value={((maxCapacity - currentCapacity) / maxCapacity) * 100} sx={{
                        height: 5,
                        borderRadius: 5,
